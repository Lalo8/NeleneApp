export default {
  ...
  description: {
    concept: {
      ...
      service1:
        "At Nelene’s, you will <span id='trait-uniquement-en'>exclusively</span> find job offers and introductions of organizations which :",
      service:
      ...
      visitorole:
        "Thanks to ask : you just have to follow our activity on our different channels. If you have any suggestion regarding a job offer or an organization that might fit our concept, please don’t hesitate to <a href='mailto:hello@nelene.com'>email us 😃 !</a> <br/>"
    }
  },
  menu: {
    tab1: "Job Offers",
